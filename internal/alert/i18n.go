...
//	weekly_warn          → %s account, %.0f pct%, %s budgetSuffix
//	weekly_crit          → %s account, %.0f pct%, %s budgetSuffix
//	weekly_budget_suffix → %.0f weeklyBudget, %.0f remaining
...
var templates = map[string]map[string]string{
	"en": {
		...
		"weekly_warn":          "🟡 <b>Weekly Quota Warning</b>\nAccount: <code>%s</code>\n7-day usage at <b>%.0f%%</b>, approaching limit%s",
		"weekly_crit":          "🚨 <b>Weekly Quota Critical</b>\nAccount: <code>%s</code>\n7-day usage at <b>%.0f%%</b>, near the limit%s",
		"weekly_budget_suffix": "\nEst. weekly budget $%.0f, about $%.0f left this week",
